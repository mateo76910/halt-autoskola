...
// Auto-generated scaffold for Predispitni test 1.
// All `isCorrect` set to false — fill in after user provides mapping.

export const PREDISPITNI_TEST_1: Exam = {
  id: "predispitni-test-1",
  slug: "predispitni-test-1",
  title: "Predispitni test 1",
  description: "Prometni propisi — predispitni test broj 1. 38 pitanja, prolaz 32 boda.",
  ...
  questions: [
    {
      ...
      points: 1,
      answers: [
        { title: "dio cestovne površine namijenjen u prvom redu za promet vozila, s jednom prometnom trakom ili više prometnih traka", isCorrect: false },
        { title: "dio cestovne površine namijenjen u prvom redu za promet pješaka, s jednom pješačkom stazom ili više pješačkih staza", isCorrect: false },
      ],
    },
    {
      id: "q2",
    ...
    },
    {
      ...
      answers: [
        ...
        { title: "cestom namijenjenom isključivo za promet motornih vozila", isCorrect: false },
      ],
    },
    {
      id: "q5",
    ...
    },
    {
      ...
      points: 1,
      answers: [
        { title: "neposredno na mjestima od kojih počinje obveza pridržavanja naredbe izražene znakom", isCorrect: false },
        { title: "150 do 250 metara prije mjesta od kojeg počinje obveza pridržavanja naredbe izražene znakom", isCorrect: false },
      ],
    },
    {
      id: "q8",
    ...
    },
    {
      ...
      points: 1,
      answers: [
        { title: "uvjeriti se da radnju može obaviti bez opasnosti za druge sudionike u prometu", isCorrect: false },
        { title: "uvjeriti se da radnju može obaviti uz što manji razmak između vozila", isCorrect: false },
      ],
    },
    {
      id: "q11",
      ...
      points: 1,
      answers: [
        { title: "smijete radi pretjecanja vozila koja se kreću sporije", isCorrect: false },
        { title: "smijete kada se mora zaustaviti zbog kvara na vozilu", isCorrect: false },
        { title: "ne smijete, jer je ta traka namijenjena samo za spora vozila", isCorrect: false },
      ],
    },
    {
      id: "q12",
    ...
    },
    {
      ...
      points: 1,
      answers: [
        { title: "zbog toga što nailazim na cestu s prednošću prolaska", isCorrect: false },
    ...
    },
    {
      ...
      answers: [
        ...
        { title: "prelaziti vozilom iz trake u traku (voziti slalom)", isCorrect: false },
      ],
    },
    {
      id: "q16",
    ...
    },
    {
      ...
      answers: [
        ...
        { title: "potvrdi smjera kretanja nakon prolaska raskrižja", isCorrect: false },
      ],
    },
    {
      id: "q18",
      ...
      points: 1,
      answers: [
        { title: "izmjenično paljenjem dvaju crvenih svjetala", isCorrect: false },
        { title: "stalno upaljenim crvenim svjetlima", isCorrect: false },
        { title: "stalno upaljenim crvenim svjetlima i zvučnim znakovima", isCorrect: false },
      ],
    },
    {
      id: "q19",
      ...
      points: 1,
      answers: [
        { title: "mjesto otvaranja prometne trake za vozila javnog prijevoza putnika", isCorrect: false },
        { title: "mjesto otvaranja prometne trake za zaustavljanje vozila u nuždi", isCorrect: false },
        { title: "mjesto otvaranja ulazne trake na brzoj cesti", isCorrect: false },
      ],
    },
    {
      id: "q20",
    ...
    },
    {
      ...
      points: 1,
      answers: [
        { title: "smanjiti brzinu i povećati pozornost prema tim vozilima", isCorrect: false },
    ...
    {
      id: "q22",
      title: "Koliko iznosi najveća dopuštena brzina kretanja vozila koje vuče drugo neispravno vozilo?",
      type: "CHECKBOX",
      points: 1,
      answers: [
    ...
    },
    {
      ...
      points: 1,
      answers: [
        { title: "propustiti isključivo vozila koja nailaze s desne strane", isCorrect: false },
        { title: "propustiti sva vozila koja se kreću tom cestom", isCorrect: false },
        { title: "propustiti vozila koja dolaze isključivo iz suprotnog smjera", isCorrect: false },
      ],
    },
    {
      id: "q24",
    ...
    },
    {
      ...
      answers: [
        ...
        { title: "zbog toga što nailazi cestom s prednošću prolaska", isCorrect: false },
      ],
    },
    {
      id: "q26",
      ...
      answers: [
        ...
        { title: "raskrižje na kojemu se prometom upravlja prometnim svjetlima", isCorrect: false },
      ],
    },
    {
      id: "q27",
    ...
    },
    {
      ...
      points: 1,
      answers: [
        { title: "Milimetri", isCorrect: false },
      ],
    },
    {
      id: "q30",
    ...
    },
    {
      ...
      points: 1,
      answers: [
        { title: "vozeći prometnom trakom uz desni rub kolnika", isCorrect: false },
        { title: "prestrojavanjem u srednju prometnu traku i iz nje obaviti skretanje", isCorrect: false },
        { title: "prestrojavanjem u krajnju lijevu prometnu traku i iz nje obaviti skretanje", isCorrect: false },
      ],
    },
    {
      id: "q32",
      ...
      points: 1,
      answers: [
        { title: "na mjestima gdje bi položajem svoga vozila ugrožavao odvijanje prometa", isCorrect: false },
        { title: "na mjestima gdje bi položajem svoga vozila ometao odvijanje prometa", isCorrect: false },
        { title: "na mjestima gdje bi položajem svoga vozila poboljšao sigurnost prometa", isCorrect: false },
      ],
    },
    {
      id: "q33",
    ...
    },
    {
      ...
      answers: [
        ...
        { title: "vožnja brzinom prilagođenom uvjetima vožnje", isCorrect: false },
      ],
    },
    {
      id: "q35",
      ...
      points: 1,
      answers: [
        { title: "pogrešna procjena brzine vozila koje usporava", isCorrect: false },
    ...
    },
    {
      ...
      answers: [
        ...
        { title: "na prvom pogodnom mjestu isključiti se iz prometa i propustiti kolonu", isCorrect: false },
        { title: "voziti što dulje sporo, kako bi se stvorila veća kolona", isCorrect: false },
      ],
    },
    {
      id: "q37",
      ...
      answers: [
        ...
        { title: "pogled usmjeriti prema desnom rubu kolnika", isCorrect: false },
